...
$ d(sin^(-1)u) / (d x) = 1 / sqrt(1-u^2) (d u) / (d x), #h(10pt) |u| < 1 $
$ d(cos^(-1)u) / (d x) = - 1 / sqrt(1-u^2) (d u) / (d x), #h(10pt) |u| < 1 $
$ d(sec^(-1)u) / (d x) = 1 / (|u|sqrt(u^2-1)) (d u) / (d x), #h(10pt) |u| > 1 $
$ d(csc^(-1)u) / (d x) = - 1 / (|u|sqrt(u^2-1)) (d u) / (d x), #h(10pt) |u| > 1 $
$ d(tan^(-1)u) / (d x) = 1 / (1+u^2) (d u) / (d x) $
$ d(cot^(-1)u) / (d x) = - 1 / (1+u^2) (d u) / (d x) $
